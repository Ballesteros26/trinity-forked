...
const Be::ClassInfo* Tr2SSAO::ExposeToBlue()
{
	EXPOSURE_BEGIN( Tr2SSAO, "" )
		...
		MAP_ATTRIBUTE( "largeEffect", m_large.enabled, "Enables/disables large-scale SSAO effect\n:jessica-group: Settings (Large)", Be::READWRITE | Be::NOTIFY )
		MAP_ATTRIBUTE_WITH_CHOOSER( "qualityLarge", m_large.quality, "Quality for the large layer of SSAO\n:jessica-group: Settings (Large)", Be::READWRITE | Be::NOTIFY | Be::ENUM, SSAOQualityChooser )
		MAP_ATTRIBUTE( "downsampledLarge", m_large.downsampled, "Use lower resolution large SSAO: low quality, but fast\n:jessica-group: Settings (Large)", Be::READWRITE | Be::NOTIFY )
		MAP_ATTRIBUTE( "zoomLevelLarge", m_large.zoomLevel, "Defines the desired detail size for large-scale effect\n:jessica-group: Settings (Large)", Be::READWRITE )
		MAP_ATTRIBUTE( "radiusLarge", m_large.settings.radius, "World (view) space size of the occlusion sphere. WARNING! LARGER VALUES AFFECTS PERFORMANCE!\n:jessica-group: Settings (Large)", Be::READWRITE )
		MAP_ATTRIBUTE( "shadowMultiplierLarge", m_large.settings.shadowMultiplier, "Effect strength linear multiplier\n:jessica-group: Settings (Large)", Be::READWRITE )
		MAP_ATTRIBUTE( "shadowPowerLarge", m_large.settings.shadowPower, "Effect strength contrast\n:jessica-group: Settings (Large)", Be::READWRITE )
		MAP_ATTRIBUTE( "shadowClampLarge", m_large.settings.shadowClamp, "Effect max limit (applied after multiplier but before blur)\n:jessica-group: Settings (Large)", Be::READWRITE )
		MAP_ATTRIBUTE( "sharpnessLarge", m_large.settings.sharpness, "How much to bleed over edges (1: not at all, 0.5: half-half; 0.0: completely ignore edges).\n:jessica-group: Settings (Large)", Be::READWRITE )
