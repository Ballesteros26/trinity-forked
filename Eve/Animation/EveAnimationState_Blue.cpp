...
const Be::ClassInfo* EveAnimationState::ExposeToBlue()
{
    EXPOSURE_BEGIN( EveAnimationState, "" )
		...
		MAP_ATTRIBUTE( "childPath", m_childPath, "Path to a space object child effect that is applied to the owner for the duration of the state", Be::READWRITE | Be::PERSIST )
