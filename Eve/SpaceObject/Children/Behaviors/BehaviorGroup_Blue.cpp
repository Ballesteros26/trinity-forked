...
const Be::ClassInfo* BehaviorGroup::ExposeToBlue()
{
	EXPOSURE_BEGIN(BehaviorGroup, "")
		...
		MAP_ATTRIBUTE("screenSizeMin", m_screenSizeMin, "Agent will be drawn as a sprite if screen-size is less than this value.", Be::READWRITE | Be::PERSIST)
		MAP_ATTRIBUTE("screenSizeMax", m_screenSizeMax, "Agent will be drawn as a mesh if screeen-size is greater than this value.", Be::READWRITE | Be::PERSIST)
